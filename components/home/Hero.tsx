...
export default function Hero() {
  ...
  <Image
    src="https://res.cloudinary.com/dncrzrttk/image/upload/f_auto,q_auto/pareja_bq6zk8.webp"
  ...
  />
      ...
      <div className="absolute bottom-[-45px] left-1/2 -translate-x-1/2 w-full pointer-events-none select-none opacity-75">
        <Image
          src="https://res.cloudinary.com/dncrzrttk/image/upload/f_auto,q_auto/adorno-boda_isn4kk.webp"
