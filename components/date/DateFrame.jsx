...
<div className="flex flex-row justify-center items-center gap-3 md:gap-12 text-[#c89b5a] w-full font-[Alex_Brush]">
  ...
  <span className="tracking-[0.2em] text-sm md:text-lg text-black border-y-2 border-[#d09242] py-1 w-20 md:w-36 text-center">
    SÁBADO
  </span>
  ...
  <div className="text-4xl md:text-6xl border-2 border-[#d09242] px-4 md:px-5 rounded-4xl text-center font-[Alex_Brush]">
    ...
    02
    <div className="text-sm md:text-sm text-black pb-4 md:pb-5">2026</div>
  </div>

  <span className="tracking-[0.2em] text-base md:text-lg text-black border-y-2 border-[#d09242] py-1 w-20 md:w-36 text-center">
    MAYO
  </span>
